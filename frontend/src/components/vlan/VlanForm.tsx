...
const inputClass =
  'w-full rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-2 text-sm text-slate-900 dark:text-white focus:border-cyan-500 focus:outline-none transition-colors';
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">
        ...
        {errors.vlan_number && <p className="mt-1 text-xs text-red-500 dark:text-red-400">{errors.vlan_number.message}</p>}
      </label>
      <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">
        Nome
      ...
      <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">
        ...
        <div className="mt-1 flex items-center gap-3">
          ...
          <span className="h-8 flex-1 rounded-lg border border-slate-300 dark:border-slate-700" style={{ backgroundColor: color }} />
        </div>
      </label>
      <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">
        Descrição
